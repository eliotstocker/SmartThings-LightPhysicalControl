...
preferences {
    page(name: "mainPage", title: "Light Control Setups", install: true, uninstall: true) {
        section {
            app(name: "lightSetup", appName: "Light Physical Button Setup", namespace: "piratemedia/smartthings", title: "New Light Setup", multiple: true)
        }
    }
}
